...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(32, 76);
			...
			// textBox2
			// 
			this->textBox2->Location = System::Drawing::Point(229, 76);
			...
			this->label2->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 9, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label2->Location = System::Drawing::Point(226, 32);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(145, 18);
			this->label2->TabIndex = 3;
			this->label2->Text = L"Reférence de l\'article";
			this->label2->Click += gcnew System::EventHandler(this, &MyForm1::label2_Click);
			// 
			// textBox3
			// 
			this->textBox3->Location = System::Drawing::Point(436, 76);
			...
			this->label3->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 9, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label3->Location = System::Drawing::Point(434, 32);
			this->label3->Name = L"label3";
			this->label3->Size = System::Drawing::Size(116, 18);
			this->label3->TabIndex = 5;
			this->label3->Text = L"Nombre d\'article";
			this->label3->Click += gcnew System::EventHandler(this, &MyForm1::label3_Click);
			// 
			// button1
			// 
			this->button1->Location = System::Drawing::Point(229, 148);
			...
			this->ClientSize = System::Drawing::Size(575, 226);
